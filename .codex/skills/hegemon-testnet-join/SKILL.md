...
compatibility: Requires ./target/release/hegemon-node, ./target/release/walletd, network access to hegemon.pauli.group:31333, and a shared chainspec at config/dev-chainspec.json.
metadata:
