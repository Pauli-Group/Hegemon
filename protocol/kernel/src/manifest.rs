    ...
    families.insert(
        ...
        FamilySpec {
            ...
            supported_actions: vec![
                ...
                protocol_shielded_pool::family::ACTION_BATCH_SHIELDED_TRANSFER,
                protocol_shielded_pool::family::ACTION_ENABLE_AGGREGATION_MODE,
                protocol_shielded_pool::family::ACTION_SUBMIT_CANDIDATE_ARTIFACT,
