...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    let public_values = PublicAir::<Base, 4>::trace_to_public_values(&traces.public_trace);
    prover.verify_all_tables_with_public_values(&proof, &common, Some(public_values))?;
