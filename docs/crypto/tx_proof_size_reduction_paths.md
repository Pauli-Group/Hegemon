...
- historical benchmark profile: `rho = 2`, `nb_opened_evals = 3`, `beta = 3`, `decs_nb_evals = 16384`, `decs_nb_opened_evals = 26`, `decs_eta = 3`, zero grinding bits; this is not the active deployed security profile
