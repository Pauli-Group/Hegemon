//! One-main native-word M4 implementation substrate for the isolated mixed
//! conventional-hash candidate.
//!
//! [`mixed_candidate`] is the only candidate API.  The copied F4 helper code
//! below remains private implementation scaffolding while the new compiler
//! reuses its non-hash word gadgets.  This crate is isolated research source:
//! it is not reachable from consensus, is not zero knowledge, and is not
//! evidence for the strict PQ128 target.

#![forbid(unsafe_code)]

pub mod mixed_candidate;
...
pub(crate) const UPSTREAM_REVISION: &str = "3f96163049f680b2909f6545690bd929f1b48c44";
pub(crate) const PUBLIC_BYTES: usize = CANONICAL_STATEMENT_BYTES;
pub(crate) const STATEMENT_WORDS: usize = PUBLIC_BYTES.div_ceil(8);
pub(crate) const DERIVED_INTENT_WORDS: usize = DIGEST_WORDS;
pub(crate) const PUBLIC_WORDS: usize = STATEMENT_WORDS + DERIVED_INTENT_WORDS;
pub(crate) const PRIVATE_WORDS: usize = 671;
pub(crate) const PRIVATE_BYTES: usize = PRIVATE_WORDS * 8;
pub(crate) const INPUT_WORDS: usize = 261;
pub(crate) const OUTPUT_WORDS: usize = 30;
pub(crate) const AUTH_WORDS: usize = 89;
pub(crate) const DIGEST_WORDS: usize = DIGEST_BYTES / 8;
pub(crate) const SHAKE256_RATE_BYTES: usize = 136;
pub(crate) const SHAKE256_RATE_WORDS: usize = SHAKE256_RATE_BYTES / 8;
/// Fixed upstream weak-profile rate. It is deliberately not caller-selectable.
#[cfg(feature = "prototype-weak")]
pub(crate) const WEAK_LOG_INVERSE_RATE: usize = 2;
/// The pinned upstream verifier hard-codes a 96-bit query target.
#[cfg(feature = "prototype-weak")]
pub(crate) const UPSTREAM_SECURITY_BITS: usize = binius_verifier::SECURITY_BITS;
/// The pinned M4 proof commits unmasked witness oracles.
#[cfg(feature = "prototype-weak")]
pub(crate) const BACKEND_IS_ZERO_KNOWLEDGE: bool = false;
/// This upstream profile has no strict composed PQ128 evidence.
#[cfg(feature = "prototype-weak")]
pub(crate) const BACKEND_IS_STRICT_PQ128: bool = false;
/// This isolated backend is never an authorized release verifier.
#[cfg(feature = "prototype-weak")]
pub(crate) const BACKEND_RELEASE_AUTHORIZED: bool = false;

pub(crate) const OFFSET_FLAGS: usize = 10;
pub(crate) const OFFSET_ANCHOR: usize = 14;
pub(crate) const OFFSET_NULLIFIERS: usize = 70;
pub(crate) const OFFSET_COMMITMENTS: usize = 182;
pub(crate) const OFFSET_CIPHERTEXT_HASHES: usize = 294;
pub(crate) const OFFSET_ASSETS: usize = 406;
pub(crate) const OFFSET_FEE: usize = 438;
pub(crate) const OFFSET_VALUE_BALANCE_SIGN: usize = 446;
pub(crate) const OFFSET_VALUE_BALANCE_MAGNITUDE: usize = 447;
pub(crate) const OFFSET_STABLE_ENABLED: usize = 455;
pub(crate) const OFFSET_STABLE_ASSET: usize = 456;
pub(crate) const OFFSET_STABLE_VERSION: usize = 464;
pub(crate) const OFFSET_STABLE_ISSUANCE_SIGN: usize = 468;
pub(crate) const OFFSET_STABLE_ISSUANCE_MAGNITUDE: usize = 469;
pub(crate) const OFFSET_STABLE_POLICY: usize = 477;
pub(crate) const OFFSET_STABLE_ORACLE: usize = 533;
pub(crate) const OFFSET_STABLE_ATTESTATION: usize = 589;
pub(crate) const OFFSET_BALANCE_TAG: usize = 645;
pub(crate) const OFFSET_ACTIVATION: usize = 701;
...
struct DecodedPublic {
    ...
    pub stable_policy: Vec<Wire>,
    pub stable_oracle: Vec<Wire>,
    pub stable_attestation: Vec<Wire>,
...
fn decode_public(builder: &CircuitBuilder, public: &[Wire; STATEMENT_WORDS]) -> DecodedPublic {
    ...
    DecodedPublic {
        ...
        stable_policy: public_words_at(builder, public, OFFSET_STABLE_POLICY).to_vec(),
        stable_oracle: public_words_at(builder, public, OFFSET_STABLE_ORACLE).to_vec(),
        stable_attestation: public_words_at(builder, public, OFFSET_STABLE_ATTESTATION).to_vec(),
...
fn constrain_non_hash(
    ...
    constrain_auth_non_hash(builder, wires, &modes, &policy, true);
...
#[cfg(feature = "prototype-weak")]
struct ResearchWeakTransparentM4Backend {
    built: BuiltFullM4,
...
fn public_words_from_binding(binding: FullProofBinding<'_>) -> [u64; PUBLIC_WORDS] {
