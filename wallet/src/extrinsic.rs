...
/// Derive the canonical runtime account id from a deterministic ML-DSA seed.
...
mod tests {
    ...
    #[test]
    fn test_ml_dsa_account_id_derivation() {
        let seed = [0u8; 32];
        let account_id = ml_dsa_account_id_from_seed(&seed);
