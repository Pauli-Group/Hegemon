...
Current September 18 status: the fixed-cap `HGV8RP04` authorization/nullifier
repair is in integration, not production. It preserves q38 and existing
proof/action caps; its changed relation and v5 addresses require new validation.
The middle-support count, full security composition and adaptive privacy remain
open. Retained older proofs do not qualify this candidate.
