...
* Native action state effects are planned before memory replay, sled-backed import, or canonical index rebuild mutates state. The Lean-conformance-checked planner rejects canonical ciphertext/commitment count mismatch, checked u64 commitment leaf-count overflow, zero or duplicate nullifiers, and already-consumed inbound bridge replay keys before commitment, nullifier, replay, action, or ciphertext-index writes occur.
