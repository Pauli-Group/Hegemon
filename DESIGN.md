...
* In aggregation mode + `SelfContained`, block production/import is fail-closed: proofless transfers require `submit_aggregation_proof`; there is no fallback to per-tx proof verification.
