...
* In aggregation mode + `SelfContained`, block production/import is fail-closed: proofless transfers require `submit_proven_batch`; there is no fallback to per-tx proof verification.
