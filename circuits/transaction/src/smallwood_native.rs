...
unsafe extern "C" {
    fn hegemon_smallwood_candidate_prove(
        ...
        linear_coefficients: *const u64,
        linear_targets: *const u64,
        binding_check_count: c_uint,
...
pub fn prove_candidate(
    ...
    let ret = unsafe {
        hegemon_smallwood_candidate_prove(
            ...
            linear_coefficients.as_ptr(),
            linear_targets.as_ptr(),
            linear_targets.len() as u32,
            binded_data.as_ptr(),
