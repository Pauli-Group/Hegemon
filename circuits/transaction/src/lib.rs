...
pub use smallwood_engine::{
    ...
    piop_recompute_transcript, smallwood_binding_words_v1, smallwood_poseidon2_coeffs_v1,
    ...
    smallwood_proof_from_trace_v1, report_smallwood_proof_size_v1, validate_proof_shape,
    ...
    SmallwoodVerifierTraceV1, DIGEST_BYTES, NONCE_BYTES, SMALLWOOD_BETA,
...
pub use smallwood_frontend::{
    ...
    prove_smallwood_candidate_with_arithmetization, report_smallwood_candidate_proof_size,
    verify_smallwood_candidate_proof_bytes, SmallwoodCandidateProof,
    SmallwoodCandidateProofSizeReport, SmallwoodFrontendShape, SmallwoodPoseidonLayout,
    SmallwoodPublicBindingMode,
};
