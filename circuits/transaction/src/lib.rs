...
pub use smallwood_engine::{
    ...
    smallwood_proof_from_trace_v1, validate_proof_shape, xof_decs_opening, xof_piop_opening_points,
    SmallwoodArithmetization, SmallwoodConfig, SmallwoodPcsVerifierTraceV1,
    SmallwoodPiopVerifierTraceV1, SmallwoodProof, SmallwoodProofTraceV1,
    SmallwoodTranscriptBackend, SmallwoodVerifierTraceV1, DIGEST_BYTES, NONCE_BYTES,
