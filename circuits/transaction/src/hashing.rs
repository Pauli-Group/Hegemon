...
mod poseidon_compat_tests {
    ...
    #[test]
    fn poseidon_merkle_hash_matches_pallet() {
        // Test with zeros
        let circuit_result = super::merkle_node(Felt::new(0), Felt::new(0)).as_int();
        ...
        let circuit_result = super::merkle_node(Felt::new(1), Felt::new(2)).as_int();
        ...
        let circuit_result = super::merkle_node(Felt::new(large1), Felt::new(large2)).as_int();
