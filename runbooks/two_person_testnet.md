...
- **Approved seed list (`HEGEMON_SEEDS`):** `hegemon.pauli.group:30333,158.69.222.121:30333`
...
```bash
HEGEMON_SEEDS="hegemon.pauli.group:30333,158.69.222.121:30333" ./scripts/start-mining.sh
```
...
- Ensure `HEGEMON_SEEDS` uses the approved seed list: `hegemon.pauli.group:30333,158.69.222.121:30333`
