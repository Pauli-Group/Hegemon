...
def vectorJson : String :=
  "{\n"
    ...
    ++ statementHashCaseJson "overwidth-circuit-version-rejected"
        overwidthCircuitVersionFields ++ ",\n"
    ++ statementHashCaseJson "overwidth-stablecoin-policy-version-rejected"
        overwidthStablecoinPolicyVersionFields ++ "\n"
    ++ "  ],\n"
