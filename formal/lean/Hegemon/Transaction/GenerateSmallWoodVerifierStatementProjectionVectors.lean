...
def projectionCases : List (String × String × Nat × VerifierStatementProjectionInput) :=
  [ ("active-inline-merkle-verifier-statement-projection", "active_inline_merkle",
    ...
    ("active-inline-merkle-128-verifier-statement-projection", "active_inline_merkle",
    ...
    ("stablecoin-inline-merkle-verifier-statement-projection", "stablecoin_inline_merkle",
      arithDirectPacked64CompactBindingsInlineMerkleSkipInitialMdsV1,
      validInlineMerkleProjectionInput),
    ("stablecoin-inline-merkle-128-verifier-statement-projection", "stablecoin_inline_merkle",
      arithDirectPacked128CompactBindingsInlineMerkleSkipInitialMdsV1,
      validInlineMerkleProjectionInput),
    ...
    ("auxiliary-limb-count-drift-128-rejected", "active_inline_merkle",
      arithDirectPacked128CompactBindingsInlineMerkleSkipInitialMdsV1,
      caseWith fun input => { input with auxiliaryWitnessLimbCountMatches := false }),
