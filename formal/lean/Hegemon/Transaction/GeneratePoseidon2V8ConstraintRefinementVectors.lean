...
open Hegemon.Transaction.Poseidon2V8ConstraintRefinement
...
def activeHashKernelGeometry : HashKernelGeometryVector :=
  { width := Poseidon2Width16Kernel.width
    ...
    hashRowStart := Poseidon2V8ConstraintRefinement.hashRowStart
    stableRowStart := Poseidon2V8ConstraintRefinement.stableRowStart
    stableRows := stableRowCount
    relationRows := relationRowCount
    packingFactor := Poseidon2V8ConstraintRefinement.packingFactor
...
def vectorJson : String :=
  "{\n"
    ++ "  \"schema\": \"hegemon.poseidon2-v8.source-executable-refinement-v2\",\n"
    ...
    ++ toString Poseidon2V8RelationProgram.canonicalProgramTranscriptBytes ++ ",\n"
    ++ "  \"program_sha512\": "
    ++ stringJson Poseidon2V8RelationProgram.canonicalProgramSha512Hex ++ ",\n"
    ++ "  \"relation_id_48\": "
    ++ stringJson Poseidon2V8RelationProgram.canonicalNativeRelationIdHex ++ ",\n"
