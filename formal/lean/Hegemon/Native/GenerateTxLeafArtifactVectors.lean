...
def vectorJson : String :=
  "{\n"
    ...
    ++ txLeafCaseJson "retired-version-missing-backend-defaults-smallwood" retiredVersionMissingBackendArtifact ++ ",\n"
    ++ txLeafCaseJson "retired-backend-rejected" retiredBackendArtifact ++ ",\n"
