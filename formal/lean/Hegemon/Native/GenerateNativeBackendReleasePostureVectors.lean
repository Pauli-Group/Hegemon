...
def releasePostureCaseJson
  ...
  "    {\n"
    ...
    ++ "      \"acceptance_artifact_mentions_accepted\": "
      ++ boolJson input.acceptanceArtifactMentionsAccepted ++ ",\n"
    ++ "      \"acceptance_artifact_mentions_external\": "
      ++ boolJson input.acceptanceArtifactMentionsExternal ++ ",\n"
    ++ "      \"expected_valid\": "
