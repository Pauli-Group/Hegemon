...
def vectorJson : String :=
  "{\n"
    ...
    ++ caseJson "valid-empty-wallet-envelope-fields" "valid_empty_wallet_envelope_fields"
      validRequest ++ ",\n"
    ++ caseJson "valid-outbound-bridge-request" "valid_outbound_bridge_request"
      validRequest ++ ",\n"
    ++ caseJson "valid-inbound-bridge-request" "valid_inbound_bridge_request"
      validRequest ++ ",\n"
    ++ caseJson "valid-bridge-verifier-registration-request"
      "valid_bridge_verifier_registration_request" validRequest ++ ",\n"
    ++ caseJson "valid-inline-transfer-request" "valid_inline_transfer_request"
      validRequest ++ ",\n"
    ++ caseJson "valid-sidecar-transfer-request" "valid_sidecar_transfer_request"
      validRequest ++ ",\n"
    ++ caseJson "valid-sidecar-empty-proof-request" "valid_sidecar_empty_proof_request"
      validRequest ++ ",\n"
    ++ caseJson "valid-candidate-artifact-request" "valid_candidate_artifact_request"
      validRequest ++ ",\n"
    ++ caseJson "valid-coinbase-request" "valid_coinbase_request"
      validRequest ++ ",\n"
