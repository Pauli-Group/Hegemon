...
def vectorJson : String :=
  "{\n"
    ...
    ++ caseJson "tip-extension-batch-plan-length-mismatch-rejected"
    ...
    ++ caseJson "tip-extension-batch-block-record-write-mismatch-rejected"
      { validTipExtensionBatchCommit with blockRecordWrites := 2 } ++ ",\n"
    ++ caseJson "noncanonical-block-record-batch-write-count-mismatch-rejected"
