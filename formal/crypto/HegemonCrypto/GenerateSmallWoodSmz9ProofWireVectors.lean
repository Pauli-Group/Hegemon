...
namespace GenerateSmallWoodSmz9ProofWireVectors

open SmallWoodSmz9ProofWire
open SmallWoodSmz9ProofWire.Examples
...
def render : String :=
  "{\n  \"schema_version\": 1,\n  \"profile\": {\n"
    ...
    ++ "    \"maximum_compact_authentication_nodes\": "
      ++ toString maximumCompactAuthenticationNodes ++ ",\n"
    ++ "    \"opened_witness_mode\": 1,\n"
...
end GenerateSmallWoodSmz9ProofWireVectors
end HegemonCrypto

def main : IO Unit :=
  IO.println HegemonCrypto.GenerateSmallWoodSmz9ProofWireVectors.render
