...
- [x] (2026-09-09) Preserve the native body-proof V3 failed preflight:
  its guards pass, then source pinning rejects the current RelationProgram
  metadata identity change before any Lean process starts. Receipt SHA-256
  is `47f69f3e5d4a7289c0e16e263beca9feb49b597a5c4b296ecc1e70f7e6f3248b`.
  The exact source diff changes three identity constants, not evaluators.
- [x] (2026-09-09) Run the distinct V4 current-program native closure:
  all fifteen prerequisite compilations pass, but the original body proof
  fails on mechanical simplification and reveals two implicit native-decision
  string-bound assumptions. Preserve failed receipt
  `2a7f6a9ba8d3b6597aad665d3d6b80c06563270e2180d641c6f2aea8761884ae`.
- [x] (2026-09-09 03:07 UTC) Qualify all 21 native node-body roots against
  a separate derivative with exactly two explicit ordinary-kernel string-bound
  proof arguments. The V6 string-bound roots use only `propext`; every V12
  body root uses only the three permitted standard axioms. Complete before/
  after checks cover 136 pinned inputs and 16,797 dependency records; peak
  child RSS is 2,249,539,584 bytes. Receipt SHA-256 is
  `01aad797e0b92f0cb19e785168420a294e7b213f2a3de4710677b164fbc4d53f`.
  V5-V11 failed attempts remain uncredited, including the coordinator's
  wrong-host-Python invocation and misplaced proof edit. The original Rust,
  LLBC, generated bytes, translator and libraries remain unchanged. This
  does not credit the original elaborated constants or full R0.
- [x] (2026-09-09) Qualify complete canonical node-array induction and exact
  original evaluator correspondence: three main roots and six original-
  predicate boundary controls pass. The proof requires original source-node
  validity and canonical inputs, not execution success. V3 receipt SHA-256
  is `c27bf03d1d5d6aac062533da32ea2e04b2bb2ef7e2fea7ded2f9d0b78073d56e`.
- [x] (2026-09-09) Qualify the public-only extension with actual empty
  witness rows, retaining the three true-case signatures. All 17 roots use
  only permitted standard axioms; before/after checks cover 159 pinned
  inputs and 16,798 dependency records. Peak child RSS is 2,244,247,552
  bytes. Receipt SHA-256 is
  `a67299c94e885da8caf1c209bfdefe27ddc49e18c180ae12680f63440e382452`.
  Retain 221 files / 29,208,236 bytes in
...
Rebuild the isolated native proof closure after the current relation-identity
constants change. Preserve historical source/compiled-output bindings and the
V3 failed preflight. Exclude every old local proof/generated/Hegemon output
root from the new search path; reuse only the frozen external library closure.
Retain single-worker M2800, less-than-3-GiB RSS, cumulative 50-MiB Stage6 packet
and 300-second invocation limits. Date/author: 2026-09-09, coordinator.
...
Revision note (2026-09-09): preserve the native-body V3 preflight rejection
and explicitly separate historical scalar evidence from the current program
identity. Prepare a fresh local closure for V4 without weakening resource,
source-pin, dependency or proof-axiom controls.

Revision note (2026-09-09): retain V4's actual body-proof failure and identify
the upstream implicit native string-bound assumptions. Prepare only the exact
two-proof-argument V5 derivative and mechanical proof corrections, preserving
all original sources and the strict axiom gate; do not credit the old compiled
body or full R0 from this candidate.
