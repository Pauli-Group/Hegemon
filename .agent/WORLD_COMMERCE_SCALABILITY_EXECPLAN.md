...
- [x] (2026-01-29T00:21Z) Re-ran throughput harness on safe, non-colliding ports (`HEGEMON_TP_RPC_PORT=9957`, `HEGEMON_TP_P2P_PORT=31335`, `TX_COUNT=8`): block 12 `extrinsics_bytes_total=1,462,165`, `proof_da_blob_bytes_estimate=2,858,042`, `aggregation_proof_bytes=1,202,267`, `verify_ms=6,692` (`aggregation_verify_ms=6,510`), ciphertext bytes `34,352` (log: `/tmp/hegemon-throughput.log`).
...
- [x] (2026-01-29T01:25Z) Re-ran throughput bench at tx_count=8 with compressed aggregation proofs: block 12 `extrinsics_bytes_total=1,010,840`, `aggregation_proof_bytes=750,942`, `aggregation_proof_uncompressed_bytes=1,203,056`, `proof_da_blob_bytes_estimate=2,858,808`, `verify_ms=5,560` (`aggregation_verify_ms=38`, cache build 5,332ms), ciphertext bytes `34,352` (log: `/private/tmp/hegemon-throughput.log`). Baseline (pre-compression) block 12: `extrinsics_bytes_total=1,462,922`, `aggregation_proof_bytes=1,203,024`, `verify_ms=6,092` (log: `/private/tmp/hegemon-throughput.log`).
- [x] (2026-01-29T01:42Z) Re-ran throughput bench at tx_count=16 with compressed aggregation proofs: block 21 `extrinsics_bytes_total=1,120,748`, `aggregation_proof_bytes=829,922`, `aggregation_proof_uncompressed_bytes=1,295,888`, `proof_da_blob_bytes_estimate=5,716,514`, `verify_ms=11,252` (`aggregation_verify_ms=48`, cache build 10,893ms), ciphertext bytes `68,704` (log: `/private/tmp/hegemon-throughput.log`). Baseline (pre-compression) tx_count=16 block: `extrinsics_bytes_total=1,584,742`, `aggregation_proof_bytes=1,295,842`, `verify_ms=10,791` (log: `/tmp/hegemon-throughput-16.log`).
