...
run_exact multi_mib_sync_announce_preserves_tip_on_missing_parent_and_body_mismatch
...
run_exact all_known_deep_large_action_winning_sync_streams_atomic_stored_reorg_and_reopens
run_exact compact_stored_pow_ancestry_walks_synthetic_multi_mib_records_without_body_decode
run_exact streaming_stored_reorg_writes_undo_for_later_heavier_fork_and_reopen
run_exact canonical_publication_paths_advance_exact_tip_without_candidate_cache_authority
...
run_exact canonical_reorg_rejects_unknown_invalid_v8_suffix_before_prestorage
run_exact same_process_verified_block_cache_cannot_skip_reorg_proof_verification
run_exact reorg_orphan_suffix_walk_matches_legacy_order_without_full_old_chain
run_exact restarted_reorg_rejects_inactive_bridge_after_valid_v8_plan_without_any_write
run_exact reorg_rebuild_failure_preserves_canonical_indexes
...
run_exact oversized_legacy_metadata_chunk_fallback_is_closed_at_v3_import_seam
...
run_exact symmetric_legacy_chunk_sessions_fail_closed_without_directional_deadlock
...
run_exact nonwinning_invalid_v8_sync_batch_rejects_before_any_row_write
run_exact lower_height_higher_work_sync_rejects_late_invalid_row_without_partial_adoption
