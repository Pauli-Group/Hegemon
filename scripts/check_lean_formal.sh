...
(
  ...
  lake env lean Hegemon/Native/PendingActionFieldProjectionVectors.lean
  lake env lean Hegemon/Native/GeneratePendingActionFieldProjectionVectors.lean
  ...
  lake env lean Hegemon/Native/GenerateMinedBlockCommitPublicationVectors.lean
  ...
  lake env lean Hegemon/Consensus/AcceptedSmallWoodBlockComposition.lean
  lake env lean Hegemon/Consensus/GenerateAcceptedSmallWoodBlockCompositionVectors.lean
