...
(
  cd "$LEAN_ROOT"
  lake build Hegemon gen_bridge_vectors gen_bridge_checkpoint_output_vectors gen_bridge_long_range_vectors gen_bridge_header_mmr_vectors gen_bridge_header_mmr_transcript_vectors gen_bridge_flyclient_vectors gen_aggregation_v5_vectors gen_da_root_vectors gen_shielded_vectors gen_consensus_vectors gen_header_vectors gen_miner_identity_vectors gen_native_tx_leaf_admission_vectors gen_pow_vectors gen_proof_policy_vectors gen_proven_batch_binding_vectors gen_receipt_root_admission_vectors gen_recursive_block_admission_vectors gen_recursive_public_replay_vectors gen_recursive_semantic_input_vectors gen_supply_vectors gen_supply_invariant_vectors gen_tree_transition_vectors gen_version_policy_vectors gen_action_order_vectors gen_action_request_projection_admission_vectors gen_atomic_commit_manifest_admission_vectors gen_action_hash_admission_vectors gen_action_root_transcript_vectors gen_action_state_effect_vectors gen_action_stream_effect_vectors gen_action_plan_application_admission_vectors gen_action_wire_replay_projection_admission_vectors gen_announced_block_admission_vectors gen_block_index_reload_vectors gen_canonical_state_reload_vectors gen_bridge_replay_reload_vectors gen_pending_action_reload_vectors gen_action_scope_admission_vectors gen_bridge_action_payload_admission_vectors gen_bridge_witness_backscan_vectors gen_bridge_witness_export_admission_vectors gen_risc0_release_verifier_vectors gen_native_backend_review_policy_vectors gen_native_backend_release_posture_vectors gen_release_pq_binary_policy_vectors gen_dependency_audit_policy_vectors gen_transfer_action_payload_admission_vectors gen_transfer_state_admission_vectors gen_block_artifact_binding_admission_vectors gen_block_commitment_admission_vectors gen_block_replay_refinement_vectors gen_candidate_artifact_admission_vectors gen_candidate_artifact_coupling_admission_vectors gen_canonical_reorg_chain_admission_vectors gen_codec_admission_vectors gen_coinbase_accounting_admission_vectors gen_coinbase_action_payload_admission_vectors gen_mineable_action_admission_vectors gen_native_miner_identity_vectors gen_mined_work_admission_vectors gen_work_template_admission_vectors gen_recursive_artifact_context_admission_vectors gen_resource_budget_admission_vectors gen_rpc_admission_vectors gen_sidecar_upload_admission_vectors gen_staged_ciphertext_reload_vectors gen_staged_proof_reload_vectors gen_storage_durability_admission_vectors gen_sync_admission_vectors gen_network_secure_channel_vectors gen_pq_noise_vectors gen_note_ciphertext_wire_vectors gen_native_tx_leaf_artifact_vectors gen_native_receipt_root_vectors gen_transaction_vectors gen_merkle_vectors gen_public_input_vectors gen_public_input_binding_vectors gen_proof_wrapper_admission_vectors gen_statement_hash_vectors
