...
DASHBOARD_WALLET_STORE=${DASHBOARD_WALLET_STORE:-"$REPO_ROOT/state/dashboard-wallet.testpass.store"}
DASHBOARD_WALLET_META=${DASHBOARD_WALLET_META:-"$REPO_ROOT/state/dashboard-wallet.testpass.meta.json"}
DASHBOARD_WALLET_PASSPHRASE=${DASHBOARD_WALLET_PASSPHRASE:-"test passphrase"}
...
export DASHBOARD_WALLET_STORE DASHBOARD_WALLET_META DASHBOARD_WALLET_PASSPHRASE
