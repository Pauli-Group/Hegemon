...
printf '\n[1/10] Checking formal-core checker formatting\n'
cargo fmt --manifest-path "$FORMAL_MANIFEST" -- --check

printf '\n[2/10] Running formal-core checker tests\n'
...
printf '\n[4/10] Auditing formal-core checker dependencies\n'
...
printf '\n[5/10] Checking formal inventory\n'
