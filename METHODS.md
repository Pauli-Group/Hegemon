...
* In aggregation mode + `SelfContained`, proofless transfers require a valid `submit_aggregation_proof` in the same block; there is no consensus fallback to per-transaction proof verification.
